...
- This has already leaked more than once in this repo's own history (a link and a code example, both since fixed) — treat this as a standing, easy-to-repeat mistake, not a one-off.
