...
## Immediate prerequisite — `[consumer-app-b]` version mismatch
...
| P-4 | Open PR and merge                                          | `[consumer-app-b]` | ⬜     | Branch: `fix/align-mui-adapter-version`        |
...
| 2a-4  | Upgrade MUI X packages to v9 (`@mui/x-data-grid`, `@mui/x-date-pickers`, `@mui/x-tree-view`) | `[consumer-app-a]` | ⬜     | Must align with core major                                |
| 2a-5  | Apply MUI official codemods                                                                  | `[consumer-app-a]` | ⬜     |                                                           |
| 2a-6  | Resolve TypeScript errors                                                                    | `[consumer-app-a]` | ⬜     | `npm run typecheck`                                       |
| 2a-7  | Resolve ESLint errors                                                                        | `[consumer-app-a]` | ⬜     | `npm run lint`                                            |
| 2a-8  | Run `npm run check:verify`                                                                   | `[consumer-app-a]` | ⬜     |                                                           |
| 2a-9  | Visual QA: home, career timeline, icon rendering, chart cards                                | `[consumer-app-a]` | ⬜     | Run `npm run dev`, check each section                     |
| 2a-10 | Check MUI X pages: data grid, date picker usage                                              | `[consumer-app-a]` | ⬜     | MUI X v9 has its own breaking changes                     |
| 2a-11 | Verify icon offline registration test still passes                                           | `[consumer-app-a]` | ⬜     | `npx vitest run src/components/iconify/icon-sets.test.ts` |
| 2a-12 | `rm -rf .next && npm run build` (production build)                                           | `[consumer-app-a]` | ⬜     | Zero errors, zero type warnings                           |
| 2a-13 | Open PR and merge                                                                            | `[consumer-app-a]` | ⬜     | Branch: `feature/mui-9-migration`                         |

---

## Phase 2b — `[consumer-app-b]`
...
| 2b-4 | Upgrade `@mui/material-nextjs` to v9                       | `[consumer-app-b]` | ⬜     | Intentional this time — after core v9 is in |
| 2b-5 | Apply MUI official codemods                                | `[consumer-app-b]` | ⬜     |                                             |
| 2b-6 | Resolve TypeScript and ESLint errors                       | `[consumer-app-b]` | ⬜     |                                             |
| 2b-7 | Run `npm run check:verify`                                 | `[consumer-app-b]` | ⬜     |                                             |
| 2b-8 | Smoke-test: login, admin, viewer, task creation, mark done | `[consumer-app-b]` | ⬜     |                                             |
| 2b-9 | Open PR and merge                                          | `[consumer-app-b]` | ⬜     | Branch: `feature/mui-9-migration`           |
